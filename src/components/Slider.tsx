...
const Slider = () => {
	...
	return (
		<div className="relative flex flex-col items-center h-full overflow-y-hidden w-full lg:justify-center">
			...
			<div className="grid grid-cols-12 h-full lg:h-[70%] w-full pt-14 lg:pt-0">
				...
				<div className="col-span-12 lg:col-span-6 h-full relative flex flex-col items-center justify-between lg:justify-end gap-12 lg:gap-12">
					...
					<div className="w-full z-10 flex justify-center items-center !h-[50%] lg:!h-full">
						<Suspense
							fallback={
